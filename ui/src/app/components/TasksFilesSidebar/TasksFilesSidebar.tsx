...
import type { TodoItem, FileItem, Memory, Pattern, ExecutionData } from "../../types/types";
...
export const TasksFilesSidebar = React.memo<TasksFilesSidebarProps>(
  ({ todos, files, memories, patterns, learningQueue, onFileClick, collapsed, onToggleCollapse }) => {
      ...
      <div className={styles.sidebar}>
        ...
        <Tabs defaultValue={defaultTab} className={styles.tabs}>
          <TabsList className={styles.tabsList}>
            ...
            <TabsTrigger value="learning" className={styles.tabTrigger}>
              <Brain size={14} />
              Learning
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="learning" className={styles.tabContent}>
            <LearningPanel
              memories={memories}
              patterns={patterns}
